...
3. **Lottery Commitment (Trigger)**: Simulated Keepers aggressively polled `triggerLottery()`. Upon clearing the threshold, the lottery was triggered, snapshotting the active eligible liquidity buckets and logging a `targetTime`.
